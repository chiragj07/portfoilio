...
const Contact = () => {
  return (
    ...
    <h1 id="h1-about">Contact Me</h1>
        ...
        <div id="socials">
            <a href="mailto:chiragjoshi07@outlook.com"> chiragjoshi07@outlook.com</a>
            <div id="socialsholder">
               
                    <a href="https://www.linkedin.com/in/chirag-joshi-801373167" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={"24px"}>
                ...
                <a href="https://github.com/chiragj07" target="_blank" rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width={"24px"}>
